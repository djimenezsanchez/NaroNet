...
def CustomParameters(path, debug):
    ...
    if 'Cytof52Breast' in path:
        ...
        # Optimization Parameters
        args['num_samples_architecture_search'] = 185
        args['epochs'] =40# if debug else hp.quniform('epochs', 5, 25, 1)
        args['epoch'] = 0
        args['lr_decay_factor'] = 0.5# if debug else hp.uniform('lr_decay_factor', 0, 0.75)
        args['lr_decay_step_size'] = 12# if debug else hp.quniform('lr_decay_step_size', 2, 20, 1)        
    ...
    elif 'MaryHelen' in path:
        # SuperPatch
        args['GetSuperpatch'] = True
        args['Train_SuperPatchModel'] = True
        args['WholeSlide'] = False
        args['output_Dimensions'] = 1024
        args['encoder'] = 'SIMCLR'
        args['train_batch_size']=60
        args['train_epochs']=600
        args['patch_size']=250
        args['ContextMultiplication']=1.01
